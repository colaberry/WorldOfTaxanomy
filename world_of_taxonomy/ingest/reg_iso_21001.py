"""Ingest ISO 21001:2018 Educational Organizations - Management Systems."""
...
_SOURCE_URL = "https://www.iso.org/standard/66266.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the EOMS", 2, "cl_4"),
    ...
    ("6_2", "6.2 Objectives and planning to achieve them", 2, "cl_6"),
    ...
    ("8_2", "8.2 Requirements for educational products and services", 2, "cl_8"),
    ("8_3", "8.3 Design and development", 2, "cl_8"),
    ("8_4", "8.4 Control of externally provided processes", 2, "cl_8"),
    ("8_5", "8.5 Delivery of educational products and services", 2, "cl_8"),
    ("8_6", "8.6 Release of educational products and services", 2, "cl_8"),
    ...
    ("10_3", "10.3 Opportunities for improvement", 2, "cl_10"),
]


async def ingest_reg_iso_21001(conn) -> int:
    """Insert or update ISO 21001:2018 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_21001"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_21001", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
