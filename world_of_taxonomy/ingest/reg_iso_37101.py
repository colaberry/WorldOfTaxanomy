"""Ingest ISO 37101:2016 Sustainable Development in Communities - Management System."""
...
_SOURCE_URL = "https://www.iso.org/standard/61885.html"
_DATA_PROVENANCE = "manual_transcription"
_LICENSE = "Proprietary (ISO copyright)"

NODES: list[tuple[str, str, int, str | None]] = [
    ("cl_4", "Clause 4 - Context of the Community", 1, None),
    ...
    ("4_1", "4.1 Understanding the community and its context", 2, "cl_4"),
    ("4_2", "4.2 Understanding needs and expectations of interested parties", 2, "cl_4"),
    ("4_3", "4.3 Determining the scope of the management system", 2, "cl_4"),
    ("5_1", "5.1 Leadership and commitment", 2, "cl_5"),
    ("5_2", "5.2 Policy on sustainable development", 2, "cl_5"),
    ...
    ("6_2", "6.2 Sustainability objectives and planning", 2, "cl_6"),
    ("8_1", "8.1 Operational planning and control", 2, "cl_8"),
    ("8_2", "8.2 Framework for sustainable development in communities", 2, "cl_8"),
    ("8_3", "8.3 Strategies and programmes for sustainability", 2, "cl_8"),
...
async def ingest_reg_iso_37101(conn) -> int:
    """Insert or update ISO 37101:2016 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_37101"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_37101", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
