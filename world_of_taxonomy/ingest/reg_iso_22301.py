"""Ingest ISO 22301:2019 Security and Resilience - Business Continuity Management Systems."""
...
_SOURCE_URL = "https://www.iso.org/standard/75106.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the BCMS", 2, "cl_4"),
    ...
    ("6_2", "6.2 Business continuity objectives", 2, "cl_6"),
    ("8_1", "8.1 Operational planning and control", 2, "cl_8"),
    ("8_2", "8.2 Business impact analysis and risk assessment", 2, "cl_8"),
    ("8_3", "8.3 Business continuity strategies and solutions", 2, "cl_8"),
    ("8_4", "8.4 Business continuity plans and procedures", 2, "cl_8"),
    ("8_5", "8.5 Exercise programme", 2, "cl_8"),
    ("8_6", "8.6 Evaluation of documentation and capabilities", 2, "cl_8"),
...
async def ingest_reg_iso_22301(conn) -> int:
    """Insert or update ISO 22301:2019 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_22301"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_22301", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
