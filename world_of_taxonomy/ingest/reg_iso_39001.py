"""Ingest ISO 39001:2012 Road Traffic Safety Management Systems - Requirements."""
...
_SOURCE_URL = "https://www.iso.org/standard/44958.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the RTS management system", 2, "cl_4"),
    ...
    ("6_2", "6.2 RTS performance factors", 2, "cl_6"),
    ("6_3", "6.3 Road traffic safety objectives and plans", 2, "cl_6"),
    ...
    ("9_2", "9.2 Investigation of road traffic crashes", 2, "cl_9"),
    ("9_3", "9.3 Internal audit", 2, "cl_9"),
    ("9_4", "9.4 Management review", 2, "cl_9"),
    ("10_1", "10.1 Nonconformity and corrective action", 2, "cl_10"),
    ("10_2", "10.2 Continual improvement", 2, "cl_10"),
]


async def ingest_reg_iso_39001(conn) -> int:
    """Insert or update ISO 39001:2012 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_39001"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_39001", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
