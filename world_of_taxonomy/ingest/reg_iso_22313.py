"""Ingest ISO 22313:2020 Security and Resilience - Business Continuity Management Systems - Guidance."""
...
_SOURCE_URL = "https://www.iso.org/standard/75107.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("8_2", "8.2 Business impact analysis", 2, "cl_8"),
    ("8_3", "8.3 Risk assessment", 2, "cl_8"),
    ("8_4", "8.4 Business continuity strategies and solutions", 2, "cl_8"),
    ("8_5", "8.5 Business continuity plans and procedures", 2, "cl_8"),
    ("8_6", "8.6 Exercise programme", 2, "cl_8"),
    ("8_7", "8.7 Evaluation of documentation and capabilities", 2, "cl_8"),
...
async def ingest_reg_iso_22313(conn) -> int:
    """Insert or update ISO 22313:2020 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_22313"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_22313", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
