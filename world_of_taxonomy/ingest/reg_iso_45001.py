"""Ingest ISO 45001:2018 Occupational Health and Safety Management Systems - Requirements."""
...
_SOURCE_URL = "https://www.iso.org/standard/63787.html"
_DATA_PROVENANCE = "manual_transcription"
_LICENSE = "Proprietary (ISO copyright)"

NODES: list[tuple[str, str, int, str | None]] = [
    ("cl_4", "Clause 4 - Context of the Organization", 1, None),
    ("cl_5", "Clause 5 - Leadership and Worker Participation", 1, None),
    ...
    ("4_2", "4.2 Understanding needs and expectations of workers and other interested parties", 2, "cl_4"),
    ("4_3", "4.3 Determining the scope of the OH&S management system", 2, "cl_4"),
    ("4_4", "4.4 OH&S management system", 2, "cl_4"),
    ("5_1", "5.1 Leadership and commitment", 2, "cl_5"),
    ("5_2", "5.2 OH&S policy", 2, "cl_5"),
    ("5_3", "5.3 Organizational roles, responsibilities and authorities", 2, "cl_5"),
    ("5_4", "5.4 Consultation and participation of workers", 2, "cl_5"),
    ("6_1", "6.1 Actions to address risks and opportunities", 2, "cl_6"),
    ("6_2", "6.2 OH&S objectives and planning to achieve them", 2, "cl_6"),
    ...
    ("10_2", "10.2 Incident, nonconformity and corrective action", 2, "cl_10"),
    ("10_3", "10.3 Continual improvement", 2, "cl_10"),
]


async def ingest_reg_iso_45001(conn) -> int:
    """Insert or update ISO 45001:2018 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_45001"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_45001", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
