"""Ingest ISO 41001:2018 Facility Management - Management Systems - Requirements."""
...
_SOURCE_URL = "https://www.iso.org/standard/68021.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the FM system", 2, "cl_4"),
    ("5_1", "5.1 Leadership and commitment", 2, "cl_5"),
    ("5_2", "5.2 Facility management policy", 2, "cl_5"),
    ...
    ("6_2", "6.2 FM objectives and planning to achieve them", 2, "cl_6"),
    ("8_1", "8.1 Operational planning and control", 2, "cl_8"),
    ("8_2", "8.2 Coordination of demand and services", 2, "cl_8"),
    ("8_3", "8.3 Management of service delivery", 2, "cl_8"),
...
async def ingest_reg_iso_41001(conn) -> int:
    """Insert or update ISO 41001:2018 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_41001"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_41001", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
