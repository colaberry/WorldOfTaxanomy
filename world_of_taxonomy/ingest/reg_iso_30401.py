"""Ingest ISO 30401:2018 Knowledge Management Systems - Requirements."""
...
_SOURCE_URL = "https://www.iso.org/standard/68683.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the KMS", 2, "cl_4"),
    ("4_4", "4.4 Knowledge management system", 2, "cl_4"),
    ("4_5", "4.5 Knowledge management culture", 2, "cl_4"),
    ...
    ("8_2", "8.2 Knowledge life cycle", 2, "cl_8"),
...
async def ingest_reg_iso_30401(conn) -> int:
    """Insert or update ISO 30401:2018 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_30401"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_30401", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
