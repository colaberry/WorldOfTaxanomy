"""Ingest ISO 55001:2014 Asset Management - Management Systems - Requirements."""
...
_SOURCE_URL = "https://www.iso.org/standard/55089.html"
...
NODES: list[tuple[str, str, int, str | None]] = [
    ...
    ("4_3", "4.3 Determining the scope of the asset management system", 2, "cl_4"),
    ("4_4", "4.4 Asset management system", 2, "cl_4"),
    ...
    ("6_2", "6.2 Asset management objectives and planning", 2, "cl_6"),
    ("8_1", "8.1 Operational planning and control", 2, "cl_8"),
    ("8_2", "8.2 Management of change", 2, "cl_8"),
    ("8_3", "8.3 Outsourcing", 2, "cl_8"),
    ...
    ("10_2", "10.2 Preventive action", 2, "cl_10"),
    ("10_3", "10.3 Continual improvement", 2, "cl_10"),
]


async def ingest_reg_iso_55001(conn) -> int:
    """Insert or update ISO 55001:2014 system and its nodes. Returns node count."""
    await conn.execute(
    ...
    await conn.execute(
        "DELETE FROM classification_node WHERE system_id = $1", "reg_iso_55001"
    )
    for code, title, level, parent_code in NODES:
        await conn.execute(
            """INSERT INTO classification_node (system_id, code, title, level, parent_code)
               VALUES ($1, $2, $3, $4, $5)""",
            "reg_iso_55001", code, title, level, parent_code,
        )
    count = len(NODES)
    await conn.execute(
